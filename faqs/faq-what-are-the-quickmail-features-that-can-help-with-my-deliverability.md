# FAQ: What are the QuickMail features that can help with my deliverability?

QuickMail is a cold email platform designed with a strong focus on email deliverability. Our features are specifically designed to help users optimize their outreach and improve their success rates.

Here are some features our users can utilize to enhance email deliverability:
...
Warming up new email accounts is crucial for building reputation and improving deliverability. While there’s no strict timeline, we recommend a warm-up period of at least two weeks.
...
Custom domain tracking allows you to use your own brand to track what prospects do.
...
Deliverability AI automatically replaces email accounts with low deliverability scores in a campaign with those that have higher scores, ensuring your campaigns are more successful and saving you time on analyzing stats for each account.
...
Creating multiple email variations lets you try out different email copies to see which one performs best. You can measure success by looking at opens, clicks, unsubscribes, and especially replies for each variation.
...
Recipients see a banner that says, “Images in this message are hidden,” along with a prominent “Report spam” button, which can decrease reply rates and increase spam reports.
