...
- [API Authorization](#Authorization-Re83l)

- [API Documentation](#Documentation-KACWB)

- [API Endpoint](#Endpoint-Ca8N6)

- [JSON samples for API calls:](#JSON-samples-I5ra0)

- [Getting Agency information including name, ID, and URL](#Getting-Agency-information-including-name-ID-and-URL-OTyLQ)

- [Getting workspaces IDs, names, and URLs](#Getting-workspaces-IDs-names-and-URLs-ldy11)

- [Getting campaign IDs, names, and URLs](#Getting-campaign-IDs-names-and-URLs-J73QQ)

- [Getting campaign stats based on a specific campaign](#Getting-campaign-stats-based-on-a-specific-campaign-H0KlS)

- [Getting email account IDs](#Getting-email-account-IDs-Vo4c_)

- [Creating campaigns](#Creating-campaigns-BPwml)

- [Creating email steps](#Creating-email-steps-y0-J0)

- [Creating email variation](#Creating-email-variation-6C4zW)

- [Creating Wait step](#Creating-Wait-step-Y5k5l)

- [Updating send times](#Updating-send-times-W-GGo)

- [Assigning/unassigning email accounts to/from campaigns](#Assigningunassigning-email-accounts-tofrom-campaigns-KTDpA)

- [Creating custom properties](#Creating-custom-properties-DqArY)

- [Setting custom properties](#Creating-Tags-lLVAE)

- [Creating Tags](#Creating-leads-tfiKb)

- [Setting Tags](#Creating-Tags-qHfY6)

- [Getting the number of available, active, and completed leads in a campaign](#Getting-number-of-available-active-and-completed-leads-in-a-campaign-MTpV5)

- [Getting the number of leads that ran into an error](#Getting-number-of-leads-that-ran-into-an-error-wH0sp)

- [Getting leads](#Getting-leads-XnOfX)

- [Deleting Leads](#Deleting-leads--t-k2t)

- [Moving to the next page](#Moving-to-the-next-page-pjVMT)

- [Filtering: Exclude/Include workspace IDs](#Moving-to-the-next-page-1nIhH)

- Ruby samples

- [Creating a lead](#Creating-a-lead-rYkkJ)

- [Retrieving a lead's information](#Retrieving-a-leads-information-QstYe)
...
![screenshot](000_file-0cY6cjydhP.png)
...
![screenshot](003_file-QCvSmZ028e.png)
...
![screenshot](004_file-0cY6cjydhP.png)

Here’s an **article** to help you generate an API key.

![screenshot](005_file-d2Jhfcwfaz.png)

Next, click the play button. If the API key is valid, it should show the name of your agency, as well as the ID. Like this:

![screenshot](006_file-oRbUyXcmkU.png)
...
![screenshot](007_file-QCvSmZ028e.png)
