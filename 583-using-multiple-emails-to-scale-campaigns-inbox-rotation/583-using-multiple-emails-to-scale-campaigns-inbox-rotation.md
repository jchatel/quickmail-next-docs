...
- [Why rotate emails?](#Why-rotate-inboxes-HVmHu)

- [How does it work?](#How-does-it-work-eIax1)

- [How to set it up?](#How-to-set-it-up-SD4kV)

- [Match the lead's email provider](#Match-the-leads-email-provider-axdoH)

- [How to remove the email from a campaign if its deliverability goes bad?](#How-to-remove-the-email-from-a-campaign-if-its-deliverability-go-bad-2u2su)
...
![screenshot](000_file-0yMo9mCcHv.png)
...
![screenshot](001_file-XeoPVkOzCW.png)

Then go to Advanced settings -> Match prospect email provider

![screenshot](002_file-HwwzPKrqhK.png)
