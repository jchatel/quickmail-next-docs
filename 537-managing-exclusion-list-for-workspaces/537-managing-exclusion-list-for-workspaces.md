...
- [Why keep an exclusion list?](#Why-keep-an-exclusion-list-YSlr-)

- [Excluding domains](#How-to-exclude-domains-KiF8t)

- [Excluding email addresses](#How-to-exclude-email-addresses--_aZu)

- [Excluding LinkedIn profiles](#How-to-exclude-email-addresses-UktSZ)

- [Automatically adding leads to the exclusion list if they unsubscribe](#How-do-I-automatically-add-leads-to-the-exclusion-list-if-they-unsubsc-lKUJ4)

- [Automatically adding domains to the exclusion list if a lead unsubscribes](#How-do-I-automatically-add-leads-domains-to-the-exclusion-list-if-the-npqe0)
...
![screenshot](006_file-DaSNVdEmNe.png)

**Step 2.** Next, go to "LinkedIn" tab → click + LinkedIn

![screenshot](007_file-3n1ljPZA8q.png)
...
![screenshot](008_file-sbKrI5grnR.png)
