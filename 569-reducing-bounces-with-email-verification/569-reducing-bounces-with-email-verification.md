...
- [What is email verification used for?](#What-is-Email-Verification-used-for-9B2q0)

- [What are the types of email verification status?](#What-are-the-types-of-Email-Verification-status-iVuai)

- [How to configure email verification provider?](#How-to-setup-Email-Verification-jnSDj)

- [Option 1: QuickMail Verification Credits](#How-to-get-QuickMail-Verification-Credits-tByUl)

- [Option 2: External Verification Provider](#How-to-configure-External-Provider-HQGV_)

- [How to verify leads?](#How-to-Verify-Leads-CMrwK)

- [Step #1: Enable email verification in the campaign](#Step-2-Enable-Email-Verification-in-the-Campaign-EPEST)

- [Step #2: Add leads to the campaign](#Step-2-Enable-Email-Verification-in-the-Campaign-EPEST)

- [How to know if emails were already verified?](#How-to-know-if-leads-have-already-been-verified-CFx7a)

- [Troubleshooting: Leads were already added before email verification was setup](#Troubleshooting-Leads-were-already-added-to-the-campaign-before-email-6C1H7)
...
To setup email verification, QuickMail verification credits must be purchased or a third-party email verification provider must be integrated first. After purchasing email verification credits, proceed to [How to Verify Leads?](#How-to-Verify-Leads-CMrwK)
...
![screenshot](002_file-l0HeAoOfmD.png)
...
![screenshot](003_file-ERQeHjgUTG.png)
...
![screenshot](004_file-JI1wBTL591.png)
...
![screenshot](005_file-30UmZoYLST.png)
...
![screenshot](012_file-XkfJSyeH6S.png)
...
![screenshot](013_file-JWXfOoev8D.png)
...
![screenshot](019_file-uLAaP8qfNK.png)
