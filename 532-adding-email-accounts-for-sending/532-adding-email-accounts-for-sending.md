...
- [Why add an email account?](#Why-add-an-email-account-2cK2z)

- [How to add an email account?](#How-to-add-an-email-account-z3Z4y)

- [I have access to the email account](#I-have-access-to-the-inbox-Sdss2)

- [I don't have access to the email account](#I-dont-have-access--_u0D4)

- [I'm having difficulties adding an inbox, what should I do?](#Im-having-difficulties-adding-an-inbox-what-should-I-do-JM2Td)
...
- Generate an [invite link](#I-dont-have-access--_u0D4) and open it in an incognito window. Since incognito windows don't have any data, instead of loading any email account, you will need to enter the correct email and password.
