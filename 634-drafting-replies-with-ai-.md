...
💡 You can set up an AI prompt at either the Agency or Workspace level. If both are set, the **system will prioritize the workspace AI prompt**. This allows for tailored communication, ensuring each client’s tone is consistently reflected.
...
![screenshot](000_file-b9WGWl2PgP.png)
...
![screenshot](001_file-SWBBF4Cy9z.png)
...
![screenshot](004_file-YODXy3FsRT.png)
