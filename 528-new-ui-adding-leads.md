...
**Step 3. (Optional)** If you would like to add custom properties like location, custom notes, etc., click on "Custom Properties" section. Add the name of the custom property and default value.
...
**Step 5.** Click on the tags you'd like to add and finally, once all of the lead's information is entered, click on "Add"
...
**Step 3.** Use the dropdown menu to map the correct headers in the CSV to the properties in QuickMail. After that, click "Next"
...
Use the dropdown menu to map the correct headers in the CSV to the properties in QuickMail. After that, click "Next"
