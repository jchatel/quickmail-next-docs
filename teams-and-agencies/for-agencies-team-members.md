...
To add a team member, go to the agency dashboard by clicking the organization name inside a workspace

![screenshot](../images/000_file-tDPilKRabg.png)

Once you're in the agency dashboard, go to Team → Add member

![screenshot](../images/001_file-x7rrBaeoeJ.png)

Toggle 'Admin rights' on if you'd like to provide billing info access → Generate invite link

![screenshot](../images/002_file-IPwMhiNgFo.png)

Copy the invite link  →  Send it to the person you want to add to the team.

![screenshot](../images/003_file-GNShedeyp8.png)
...
Once a team member is added, it will show under '**Team**' tab in the Agency Dashboard. It indicates whether they are an admin or not.

![screenshot](../images/004_file-4RkzPVppp5.png)

To remove or provide admin access, simply click on the team member listed and change admin rights.

![screenshot](../images/005_file-zGQYNa3nM8.png)

# How to invite clients as guests?

Go to the workspace where you'd like to invite your client → Workspace Settings → Team → Guests tab → click "+ Guest" at the top right corner

![screenshot](../images/006_file-ZjxWN7cx03.png)

Select your preferred editing permission → Generate Invite Link

![screenshot](../images/007_file-qvV7GjW0EU.png)

Copy the invite link → provide it to your client.

![screenshot](../images/008_file-adAKiAGdOJ.png)
...
![screenshot](../images/009_file-6JzSY0Sws2.png)

# Why are my email accounts, Opportunities responses, and campaigns not visible to my team members?

The reason Email accounts, Opportunities items, and campaigns are not visible to other Team Members is that they are Private. Private inboxes and campaigns are only visible to owners.  To fix this, the campaign must be 'Shared'.
...
![screenshot](../images/010_file-bjKB6Y3ctM.png)

### Share a Campaign

To share a Campaign, go to the Campaign → Click on the vertical ellipsis → Settings

![screenshot](../images/011_file-2hjVh3PQhV.png)

Change the Sharing Settings to 'Shared'

![screenshot](../images/012_file-pA7qXWBzd9.png)
