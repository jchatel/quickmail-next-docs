...
- [How does campaign automation works in QuickMail?](#How-does-campaign-automation-works-in-QuickMail-5QNld)

- [What are triggers for?](#What-are-triggers-for-OR4d9)

- [How do Triggers work?](#How-do-Triggers-work--JmGUd)

- [How to setup Triggers?](#How-to-setup-Triggers-Hyyex)

- [How many leads should I add to the Triggers?](#How-many-leads-should-I-add-to-the-Triggers--eAGX6)
...
Tip: If you need help deciding how many leads to start on the campaign, please check out: [Limit the number of leads that will start a campaign using triggers](#Option-3-Limit-the-number-of-leads-that-will-start-a-campaign-using-t-iY_Zp)
