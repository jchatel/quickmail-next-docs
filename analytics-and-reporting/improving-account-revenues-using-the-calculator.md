...
The default value is 3 domains, 20 emails per domain, and 300 emails per domain but you can change it by editing these fields based on your account set up.

Based on the fields you input, we will automatically calculate how many emails daily your whole account can send.

Here's an example:

![screenshot](../images/000_file-EKCAoDVoyv.png)

Next to set is how much value each deal costs by editing this number:

![screenshot](../images/001_file-rsFKHfoErN.png)
...
![screenshot](../images/002_file-sX3briXrw1.png)

You can adjust all variables to get the ratio of each.

Here's an example of an account that generated $2200. It has 99% delivered emails; out of delivered emails 44% have opened; out of those opens, 25% replied; out of those replies 50% sent a positive reply; out of those positive replies, 40% have booked; out of those bookings, 60% has shown up; and all of those who showed up turned to be closed deals.
...
![screenshot](../images/004_file-YQCDlD21XE.png)
