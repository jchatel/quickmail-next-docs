...
- [What are leads?](#What-are-leads-H0PvR)

- [Creating leads manually](#creating)

- [Importing leads from CSV](#csv)

- [Importing leads from Google Drive](#Importing-Leads-from-Google-Drive-DqnJf)

- [Importing leads from Sales Navigator](#autoimport)

- [Importing leads from a LinkedIn Post](#Importing-Leads-from-Sales-Navigator-Tz6va)

- [Auto-importing via Google Sheet](#autoimport)

- [Auto-importing via Sales Navigator](#Importing-From-Sales-Navigator-O_Zzr)

- [Importing leads from emails received](#Auto-import-with-Sales-Navigator-QsF6l)

- [Importing leads who viewed your LinkedIn profile](#Importing-Leads-From-Emails-Received-DB_W6)
...
- [Adding Leads Manually](#creating)

- [Importing Leads from CSV](#csv)

- [Importing Leads from Google Drive](#autoimport)

- [Importing Leads from Sales Navigator](#autoimport)

- [Importing Leads from LinkedIn Posts](#Importing-Leads-from-Sales-Navigator-Tz6va)

- [Auto-importing via Google Sheet](#autoimport)

- [Auto-importing via Sales Navigator](#Auto-import-with-Sales-Navigator-hlWVw)
