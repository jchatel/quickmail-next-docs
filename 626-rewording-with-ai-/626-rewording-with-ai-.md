...
- [Why use Reword with AI?](#Why-use-it-2mOKn)

- [How does it work?](#How-does-it-work---c6P7)

- [How to use it?](#How-to-use-it--2MoBW)

- [How much does it cost?](#How-much-does-it-costs-gjmWx)

- [Handling common errors](#Handing-Common-Errors-se-To)
...
Each month, you have a set amount of AI credits available for rewording your emails. These credits refresh monthly, so you can continue using the feature as needed. If you need more credits, please check info [here](#How-much-does-it-costs-gjmWx).
...
![screenshot](000_file-j4NOqMRlqn.png)
...
![screenshot](001_file-1hsSN9Odci.png)
...
![screenshot](002_file-YODXy3FsRT.png)
