...
- [Why limit daily email sends?](#Why-limit-daily-email-sends-JF471)

- [How does the daily sending limiter work?](#How-does-the-email-limiter-work-4mHBv)

- [How to set it up for each email?](#How-to-set-it-up-for-each-email-04esv)

- [How to set it up for multiple emails?](#How-to-set-it-up-for-multiple-email-HUZam)
...
![screenshot](000_file-AmFcYR8M9i.png)
...
![screenshot](001_file-fkXeiGzzTd.png)

Then, input the limit and click confirm.

![screenshot](002_file-Ivw5pH6iL7.png)
...
![screenshot](003_file-1VN1pIeZ4q.png)
