...
- [Why do emails need to be throttled?](#Why-do-emails-need-to-be-throttled-CcgI4)

- [How to throttle emails?](#How-to-throttle-emails-oJ-CP)

- [Increase delay between emails](#Increase-the-delay-between-emails-VDIiP)

- [Limit the number of hours a campaign can send emails using send times](#Limit-the-number-of-hours-a-campaign-can-send-emails-using-send-times-wm0WY)

- [Limit the number of leads that will start a campaign using triggers](#Limit-the-number-of-hours-a-campaign-can-send-emails-using-send-times-wm0WY)
...
![screenshot](000_file-7Vom6PMOle.png)
...
![screenshot](001_file-zvImjM7lgw.png)
...
![screenshot](002_file-vYT6cSvkBP.png)

Then, add a new one.

![screenshot](003_file-NS6wOMSi3X.png)
...
![screenshot](004_file-F9kxn9zmZE.png)
...
![screenshot](005_file-sBEp2pZ4sX.png)
