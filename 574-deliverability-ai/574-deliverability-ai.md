...
- [What is Deliverability AI?](#What-is-Deliverability-AI--kbm-F)

- [What is Smart Sending Group?](#What-is-Smart-Sending-Group-hP5Uj)

- [How does Deliverability AI work?](#How-does-it-work--oANgM)

- [How are Deliverability Scores generated?](#How-are-Deliverability-Scores-generated-cUDRd)

- [What happens when email accounts get swapped out?](#What-happens-to-the-email-accounts-once-theyre-swapped-out--YYWPC)

- [How to assign email accounts to Smart Sending Groups?](#How-to-assign-email-accounts-to-Smart-Sending-Groups-XvbUQ)

- [How to remove email accounts from Smart Sending Groups?](#How-to-assign-email-accounts-to-Smart-Sending-Groups-XvbUQ)

- [When does the system swap inboxes?](#When-does-the-system-swap-inboxes-kvugH)

- [How to change Deliverability AI thresholds?](#How-to-change-deliverability-score-threshold-and-recovery-period--G0Dv-)
...
If you would like to change the threshold, see [How to change deliverability score threshold](#How-to-change-deliverability-score-threshold-and-recovery-period--G0Dv-)
...
If you would like to change the length of the recovery period, see [How to adjust recovery days](#How-to-change-deliverability-score-threshold-and-recovery-period--G0Dv-)
