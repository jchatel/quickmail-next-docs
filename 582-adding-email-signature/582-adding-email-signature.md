...
- [Why create an email signature in QuickMail?](#Why-create-an-email-signature-in-QuickMail-g2p-9)

- [How to create a signature?](#How-to-create-a-signature-EN6d4)

- [What is the signature attribute?](#What-is-the-signature-attribute-bnAGD)

- [How to create an HTML signature?](#How-to-create-an-HTML-signature-bNYjw)
