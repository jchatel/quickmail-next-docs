...
- [What is Supported in the Two-Way Sync?](#activities)

- [How to Setup HubSpot Integration?](#hubspot)

- [How to Manually Trigger an Import from HubSpot?](#import)

- [How to See Leads' Activities in Hubspot?](#activities)

- [How to Pause HubSpot Integration?](#pause)

- [How to Remove HubSpot Integration?](#delete)
