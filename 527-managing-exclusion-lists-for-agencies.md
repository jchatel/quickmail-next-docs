...
- Why keep an agency exclude list?
...
- What if I want the email address to be excluded only from certain workspaces?
...
**Note:** In this case, to make sure that domains and email addresses will only be excluded from certain workspaces, before marking them as Do Not Contact or adding domains to the DNC domain list, turn off the setting Update Organization Do Not Contact.
